namespace SqlExecuteTests.SqlServerIntegration.AppVeyor
{
    ...
    public class Sql2017InstanceInfo : AbstractSqlServerInstanceInfo
    {
        /// <summary>
        ...
        private const string _ServerConnection = @"Server=(local)\SQL2017;User ID=sa;Password=Password12!";
